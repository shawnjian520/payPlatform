package com.jd.traffic.pay.payService.alipay.service;
...
import com.jd.traffic.pay.payService.alipay.client.DefaultAliPayParser;
import com.jd.traffic.pay.payService.alipay.client.MyDefaultAliPayClient;
import com.jd.traffic.pay.payService.alipay.response.AliPayNotifyResponse;
...
public class AliPayService implements InternalPayService {
    ...
    private String notifyUrl = EnvironmentConfig.getInstance().getPropertyValue("payPlatformConfig.properties", "ali.pay.notify.url");
