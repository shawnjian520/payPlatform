...
import com.jd.traffic.pay.payApiModel.util.DateUtil;
...
import com.jd.traffic.pay.payService.wechat.request.WechatPayPrePayRequest;
import com.jd.traffic.pay.payService.wechat.request.WechatPayQueryRequest;
import com.jd.traffic.pay.payService.wechat.response.WechatPayPayNotifyResponse;
...
import com.jd.traffic.pay.util.EnvironmentConfig;
...
public class WechatPayService implements InternalPayService {
    ...
    private String notifyUrl = EnvironmentConfig.getInstance().getPropertyValue("payPlatformConfig.properties", "wechat.pay.notify.url");
    @Autowired
