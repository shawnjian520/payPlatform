...
import com.jd.traffic.pay.payService.alipay.response.AliPayRefundNotifyResponse;
...
import com.jd.traffic.pay.util.WebPropertiesUtil;
...
public class AliRefundService implements InternalRefundService {
    ...
    public Map<String, String> refundWithPwd(PayChannel payChannel, RefundOrder refundOrder) {
        ...
        params.put("refund_date", sdf.format(now));
