...
<div class="row">
    <div class="col-md-12">
         ...
         <a class="btn btn-sm btn-success" onclick="tool.openview(this,'<%=basePath%>s/biz/sysMessage/openCreate','写通知')">
            	  <font data-localize="frame_tzgl.xtz_xtz"> 写通知</font><i class="fa fa-plus"></i>
         </a>
         <a class="btn btn-sm btn-success" onclick="page.doRemove(this)">
            	 <font data-localize="frame_tzgl.xtz_sctz">删除通知 </font><i class="fa fa-times"></i>
         </a>
	        ...
	        <tbody>
	            <c:forEach items="${resultData}" var="data">
	                 <tr id="tr_${data.wid}">
	                    ...
	                    <td id="td${data.wid}">
	                    	<a style="cursor: pointer;" onclick="tool.openview(this,'<%=basePath%>s/biz/sysMessage/input/${data.wid}/1')">${data.xxbt}</a>
	                    </td>
	                    <td>${data.xxly_str}</td>
                    	<td>
                    	...
                    	<td><a style="cursor: pointer;" onclick="ckjsr('${data.wid}')" data-localize="frame_tzgl.yftz_ckjsbm">查看接收部门</a></td>
	                </tr>
