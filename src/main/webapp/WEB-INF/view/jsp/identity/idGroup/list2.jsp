...
<div id="page-content" class="row">
 ...
 <i class="fa fa-times"></i>
        ...
        <a class="btn btn-sm btn-success" data-startFrom="top" onclick="tool.openSubview(tool.initParams('<%=basePath%>s/system/syscodes/list?zdlb=jsyhz'),'','用户组分类维护')">
           <font data-localize="frame_button.update">维护用户组分类字典</font> <i class="fa fa-wrench"></i>
        </a>
