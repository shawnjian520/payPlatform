                ...
                <div class="col-sm-3">
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            <h4 class="panel-title"><span class="" data-localize="frame_xtgl.bmgl_zzjglxgl_zzjglxlb">用户组分类</span></h4>
                        </div>
...
<script type="text/javascript">
    page = {
        ...
        zTreeOnClick: function (event, treeId, treeNode) {
            Main.ajaxLoaderUrl(basePath + "/s/id/idGroup/list?grouptype=" + treeNode.id, $("#input-page-content"), '用户组列表');
        }
    }
    ...
    $(function () {
        ...
        $.post(basePath + "/s/ajax/getroletype", function (data) {
            ...
            page.zTreeOnClick(null, null, pNode);
            	...
            	Main.ajaxLoaderUrl(basePath + "/s/id/idGroup/list", $("#input-page-content"), '用户组列表');
            }
        });
    });
